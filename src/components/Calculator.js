        ...
        <section>
            ...
            <div className=' bg-gray-900 w-96 h-screen mx-auto rounded-lg overflow-hidden mt-10'>
                ...
                <div className=' w-full h-20'>
                    <input type='text' placeholder='0' value={number} className="w-full h-full border border-white text-white bg-gray-900 text-4xl text-right pr-5"/>
                </div>
